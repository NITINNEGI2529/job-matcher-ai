  ...
  useEffect(() => {
    async function fetchMatches() {
      try {
        ...
        setError(err.response?.data?.error || 'Failed to fetch AI matches.');
        showErrorToast('Failed to fetch AI matches');
      } finally {
        setLoading(false);
      }
    }
          ...
          <div className="bg-purple-50/50 border-b p-4 flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-purple-700 mb-0">Powered by Llama 3</p>
              </div>
            </div>
